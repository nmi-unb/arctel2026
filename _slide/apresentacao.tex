...
\column{0.33\textwidth}
\centering
\includegraphics[width=0.32\linewidth]{img/professores/NeliaDelBianco.png}\\[0.15em]
\textbf{Nélia Del Bianco}\\
Comunicação (jornalismo, mídia)
\column{0.33\textwidth}
\centering
\includegraphics[width=0.32\linewidth]{img/professores/VaniaLuciaRibeiroVieira.jpg}\\[0.15em]
\textbf{Vânia Lúcia Ribeiro Vieira}\\
Direito Administrativo/Regulatório
\column{0.33\textwidth}
\centering
\includegraphics[width=0.32\linewidth]{img/professores/SimoneHenriquetaCossetinScholze.jpg}\\[0.15em]
...
\column{0.33\textwidth}
\centering
\includegraphics[width=0.32\linewidth]{img/professores/BrunoRamosFernandes.png}\\[0.15em]
\textbf{Bruno Ramos Fernandes}\\
Ciências Contábeis, tributação
\column{0.33\textwidth}
\centering
\includegraphics[width=0.32\linewidth]{img/professores/AnadeOliveiraFrazaoVieiradeMello.jpg}\\[0.15em]
\textbf{Ana Frazão Vieira de Mello}\\
Direito Civil/Econômico, ex-CADE
\column{0.33\textwidth}
\centering
\includegraphics[width=0.32\linewidth]{img/professores/PriscilaAmericaSolisMendezBarreto.png}\\[0.15em]
...
\centering
\vspace{1cm}
{\Large\textbf{arctel2026@ccom.unb.br}}\\[0.8em]
{\Large\textbf{+55 61 3107 5656}}
\end{columns}
